(function ($) {
    ...
    table = $("#prescription_table").DataTable({
        lengthMenu: [
        ...
        columns: [
            ...
            { data: "file", sortable: false, orderable: false },
            {
                data: "action",
                searchable: false,
                orderable: false,
    ...
    //delete category
    $(document).on("click", ".delete_prescriptions", function (e) {
        e.preventDefault();
        var el = $(this);
        swal(
            {
                title: trans("Are you sure to delete prescriptions ?"),
                type: "warning",
