...
(function ($) {
            ...
            <tr id="component_` +
               ...
               <td>
                    <ul class="p-0 list-style-none">
                        <li>
                            <input class="select_type" value="text" type="radio" name="component[` +
                count +
                `][type]" id="text_` +
                count +
                `"  required> <label for="text_` +
                count +
                `">` +
                trans("Text") +
                `</label>
                        ...
                        <li>
                            <input class="select_type" value="select" type="radio" name="component[` +
                count +
                `][type]" id="select_` +
                count +
                `"  required> <label for="select_` +
                count +
                `">` +
                trans("Select") +
                `</label>
               ...
               <td>
                  <table class="table table-bordered reference_range">
                    <thead>
                      <tr>
                        <th class="gender text-center">` +
                trans("Gender") +
                `</th>
                        <th class="age_unit text-center">` +
                trans("Age unit") +
                `</th>
                        <th class="age_from text-center">` +
                trans("Age") +
                `</th>
                        <th class="age text-center">` +
                trans("Critical low") +
                `</th>
                        <th class="age text-center">` +
                trans("Normal") +
                ...
                `</th>
                  ...
                  <textarea class="form-control" name="component[` +
                count +
                `][reference_range]" placeholder="` +
                trans("Reference Range") +
                `"></textarea>
               </td>
               <td class="text-center">
                    <input class="check_separated" num="` +
                count +
                `" type="checkbox" name="component[` +
                count +
                `][separated]">
        ...
        <div class="card card-primary card-outline w-100">
          ...
          <div class="card-body">
            <div class="input-group form-group mb-3">
                <input type="number" class="form-control" name="component[` +
                        num +
                        `][price]" min="0" class="price" required>
    ...
    <tr>
      ...
      <td class="text-center">
          <input type="number" name="component[` +
                    component_num +
                    `][reference_ranges][` +
                    count_reference_ranges +
                    `][age_from]" class="form-control" required>
          :
          <input type="number" name="component[` +
                    component_num +
                    `][reference_ranges][` +
                    count_reference_ranges +
                    `][age_to]" class="form-control" required>
      </td>
      <td class="text-center">
          <input type="number" name="component[` +
                    component_num +
                    `][reference_ranges][` +
                    count_reference_ranges +
                    `][critical_low_from]" class="form-control">
      </td>
      <td class="text-center">
          <input type="number" name="component[` +
                    component_num +
                    `][reference_ranges][` +
                    count_reference_ranges +
                    `][normal_from]" class="form-control">
          : 
          <input type="number" name="component[` +
                    component_num +
                    `][reference_ranges][` +
                    count_reference_ranges +
                    `][normal_to]" class="form-control">
      </td>
      <td class="text-center">
          <input type="number" name="component[` +
                    component_num +
                    `][reference_ranges][` +
                    count_reference_ranges +
                    `][critical_high_from]" class="form-control">
      </td>
      <td class="text-center">
        ...
        <td>
          <div class="form-group">
              <textarea name="comments[` +
                count_comments +
                `]" class="form-control" id="" cols="30" rows="3" required></textarea>
          </div>
        </td>
        <td>
    ...
    $(document).on("click", ".add_consumption", function () {
        ...
        $(this)
            .parent()
            .parent()
            .find(".test_consumptions")
            .append(
                `
      <tr class="consumption_row">
        <td>
          <div class="form-group">
            <select class="form-control" id="consumption_product_` +
                    consumption_count +
                    `" name="consumption[` +
                    test_id +
                    `][` +
