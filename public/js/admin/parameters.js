(function ($) {
    ...
    table = $("#parameters_table").DataTable({
        lengthMenu: [
    ...
    //delete coupon
    $(document).on("click", ".delete_delete_parameter", function (e) {
        e.preventDefault();
        var el = $(this);
        swal(
            {
                title: trans("Are you sure to delete parameter ?"),
                type: "warning",
