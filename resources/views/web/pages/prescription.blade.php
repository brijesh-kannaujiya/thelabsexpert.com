            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="appointment-form-others">
                        <form action = "{{url('upload-prescription')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="file" name="prescription" class="form-control" placeholder="Subjects">
                            </div>
