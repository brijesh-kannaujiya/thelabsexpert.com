                ...
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="services-details-image">
                            <img src="{{ asset('assets/img/services-details.jpg') }}" alt="image">
                        </div>

                        <div class="services-details-desc">
                            <h3>Offering a Wide Range of Diagnostics Services</h3>
                            ...
                            <h3>Lab by Passionate Experts</h3>
                            ...
                            <ul class="features-list">
                                <li><i class="las la-check"></i> Free Home Sampling</li>
                                <li><i class="las la-check"></i> High- End Technology</li>
                                <li><i class="las la-check"></i> Patient Support</li>
                                <li><i class="las la-check"></i> 500 + Different Tests</li>
                            </ul>

                            <div class="text-result">
                                <h3>How to get result quickly in a week</h3>
                                <p>Surrounded by their possessions, pets, and a familiar environment, our clients receive
                                    the support they ned to enjoy their regular activities and continue living well at home.
                                </p>
                            </div>
                            ...
                            <div class="services-details-faq">
                                <ul class="accordion">
                                    ...
                                    <li class="accordion-item">
                                        <a class="accordion-title" href="javascript:void(0)">It’s better to be first in the
                                            mind than in the market? <i class="las la-plus"></i></a>
                                        <p class="accordion-content">Lorem ipsum dolor sit amet, consectetur adipiscing
                                            elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                            incididunt ut labore et dolore magna aliqua.</p>
                                    </li>
