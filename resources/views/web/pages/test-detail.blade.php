                                    ...
                                    @forelse ($parameters as $key => $parameter)
                                        <li class="accordion-item">
                                            <a class="accordion-title @if ($key == 0) active @endif"
                                                ...
                                                {{ $parameter->name }} <i class="las la-plus"></i>
                                            </a>
                                            <div
                                    ...
                                    @empty
                                        @foreach ($Chieldtests as $key => $Chieldtest)
                                            <li class="accordion-item">
                                                <a class="accordion-title @if ($key == 0) active @endif"
                                                    href="javascript:void(0)">
                                                    {{ $Chieldtest->test->test_name }} <i class="las la-plus"></i>
                                                </a>
                                                <!--<p class="accordion-content @if ($key == 0) show @endif text-stone-950">-->
                                                <!--    {{ $Chieldtest->test->short_desc }}-->
                                                <!--</p>-->
                                            </li>
                                        @endforeach
                                    @endforelse
