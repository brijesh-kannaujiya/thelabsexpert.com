                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody class="test_consumptions">
                                    ...
                                    <tr class="consumption_row">
                                        <td>
                                            <select class="form-control product_id" id="consumption_product_{{$consumption_count}}" name="consumption[{{$test['id']}}][{{$consumption_count}}][product_id]" required>
                                                <option value="{{$consumption['product_id']}}" selected>{{$consumption['product']['name']}}
                                                </option>
                                            </select>
                                        </td>
                                        <td>
                                            <input type="number" class="form-control" name="consumption[{{$test['id']}}][{{$consumption_count}}][quantity]" placeholder="{{__('Quantity')}}" value="{{$consumption['quantity']}}" required>
                                        </td>
                                        <td>
