            ...
            <div class="card-body m-0 p-0">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <a href="@if(!empty(auth()->user()->avatar)){{url('uploads/user-avatar/'.auth()->user()->avatar)}}@else{{url('img/avatar.png')}}@endif" data-toggle="lightbox" data-title="Avatar">
                            <img src="@if(!empty(auth()->user()->avatar)){{url('uploads/user-avatar/'.auth()->user()->avatar)}}@else{{url('img/avatar.png')}}@endif" class="img-thumbnail" id="patient_avatar" alt="">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div class="card card-primary">
                    ...
                    <div class="card-body p-1">
                        <a href="@if(!empty(auth()->user()->signature)){{url('uploads/signature/'.auth()->user()->signature)}}@else{{url('img/no-image.png')}}@endif" data-toggle="lightbox" data-title="Signature">
                            <img src="@if(!empty(auth()->user()->signature)){{url('uploads/signature/'.auth()->user()->signature)}}@else{{url('img/no-image.png')}}@endif" class="img-thumbnail" id="user_signature" alt="">
                        </a>
                    </div>
                </div>
            </div>
