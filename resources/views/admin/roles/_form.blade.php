<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            <label>{{__('Name')}}</label>
            <input type="text" class="form-control" name="name" placeholder="{{__('Role Name')}}" @if(isset($role)) value="{{$role['name']}}" @endif required>
        </div>
    </div>
</div>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <label class="switch">
                                        <input type="checkbox" name="permissions[][permission_id]" value="{{$permission['id']}}" id="{{$permission['key']}}">
